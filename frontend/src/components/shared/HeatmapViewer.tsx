    ...
    return (
        <div className="flex flex-col space-y-4">
            <div className="flex items-center justify-between px-2">
                <h3 className="font-semibold text-lg tracking-tight">ELA Forensic Comparison</h3>
                <p className="text-sm text-balance text-muted-foreground">Original vs Error Level Analysis</p>
            </div>
